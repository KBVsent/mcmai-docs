...
features:
  ...
  - icon: 🏆
    title: ランキングシステム
    details: 全体楽曲ランキング・グループ内ランキング・Rating ランキングで多角的に比較。
  - icon: 🔍
    title: 強力な楽曲検索
    details: 曲名・別名・作曲者・譜面製作者・BPM・定数など多条件で検索可能。
  - icon: 📈
    title: 進捗トラッキング
    details: レベル進捗・ジャンル進捗・コンプリート表でゲームの状況を一目で把握。
  - icon: ⚙️
    title: 柔軟な設定
...
- **Discord サーバー**：[参加する](https://discord.gg/fvAU8sTcWz)
- **LINE グループ**：[参加する](https://line.me/ti/g/EKt3QG4bbX)
